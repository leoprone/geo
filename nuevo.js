...
function recarga(sel, clearDescription){
        ...
        var filtro=[];
        d3.json("empresas_biotecnologicas.json").then(function(data){
        ...
        /*  var argentina = data.features.filter(function(feature) {
                ...
                g.selectAll("path")
                    ...
                    .attr("fill",  function(d) {
                        ...
                        if (d.properties.NAME==="Argentina"){
                            return "rgb(19, 71, 31)"; // color Argentina
                        } else {
                ...
                g.selectAll("circle")
                    ...
                    .attr("class", function(filtro){
                        if(filtro.rama=="agricultura"){
                            return "rama-agricultura";
                        }
                        if(filtro.rama=="farmaceutica"){
                            return "rama-farmaceutica";
                        }
                        if(filtro.rama=="diagnostico"){
                            return "rama-diagnostico";
                        }
                    ...
                    .on("click", function(event, d) {
                        ...
                        d3.select("#tooltip")
                           ...
                           /*  .style("top", (event.pageY + 10) + "px")
                            ...
                            .html(function(){
                                if(d.rama=="agricultura"){
                                    return `
                                     <h3>${d.nombre}</h3><br>
                                     <h4>Rama: Agricultura</h4>
                                        `
                                     }
                                if(d.rama=="farmaceutica"){
                                    return `
                                        <h3>${d.nombre}</h3><br>
                                        <h4>Rama: Farmacéutica</h4>
                                        `
                                    }
                                if(d.rama=="diagnostico"){
                                    return `
                                        <h3>${d.nombre}</h3><br>
                                        <h4>Rama: Diagnóstico</h4>
                                        `
                                }
                            })
